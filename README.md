...
| 테스트       | 시나리오           | 평균 응답  | p95     | 에러율 |
|-----------|----------------|--------|---------|-----|
| Load      | 기본 부하          | 33.7ms | 45.3ms  | 0%  |
| Stress    | 점진적 증가         | 38.3ms | 63.1ms  | 0%  |
| Spike     | 급격한 트래픽        | 53.7ms | 103.2ms | 0%  |
| Mixed     | 읽기/쓰기 혼합 스파이크  | 1.95s  | 4.93s   | 0%  |
| Realistic | 실제 사용 패턴 시뮬레이션 | 28.3ms | 44.1ms  | 0%  |

    ...
    return (
      ...
      <span className={"speed-check"}>
        {displayCurrentCpm ? `Current CPM` : `Last CPM`}
            ...
            {displayCurrentCpm ? (
                <span
                    className={isDark ? "speed-check speed-check-num dark" : "speed-check speed-check-num"}>{currentCpm}</span>
            ) : (
                <span
                    className={isDark ? "speed-check speed-check-num dark" : "speed-check speed-check-num"}>{lastCpm}</span>
            )}
        </div>
    );
};
